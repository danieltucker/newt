...
export function CommentBar({ count, onClick, onExplore, onRepost, shareUrl }: {
   ...
   * this instance's page *for* that address on the clipboard - not the
   ...
   *
   * Which page that is depends on whether the address is a post written here;
   * see shareLinkFor. The copy happens there rather than in each caller so
   * every surface showing this pill shares the same link in the same form.
   */
  shareUrl?: string;
}) {
